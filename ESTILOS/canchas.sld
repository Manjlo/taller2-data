...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>canchas_futbol</se:Name>
    <UserStyle>
      <se:Name>canchas_futbol</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Pasto</se:Name>
          <se:Description>
            <se:Title>Pasto</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Pasto</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:LineSymbolizer>
            <se:Stroke>
        ...
        <se:Rule>
          <se:Name>Pavimento</se:Name>
          <se:Description>
            <se:Title>Pavimento</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Pavimento</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
        ...
        <se:Rule>
          <se:Name></se:Name>
          <se:Description>
            <se:Title>tipo is ''</se:Title>
          </se:Description>
          <se:ElseFilter xmlns:se="http://www.opengis.net/se"/>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#d4a72d</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
